...
export const JOTFORM_SCRIPT_SRC =
  "https://form.jotform.com/jsform/252446531988064";
...
export const STATS = [
  ...
  {
    value: "60%",
    label: "of Members from Organic (Free)",
    numeric: 60,
    unit: "%",
  },
  {
    value: "30–40%",
    label: "Trial-to-Membership Conversion",
    numeric: 40,
    unit: "%",
  },
];
...
export const KPI_BENCHMARKS = [
  ...
  {
    metric: "Trial-to-Membership Conversion",
    target: "30–40%",
    note: "vs. 20% industry avg.",
  },
  {
    metric: "Cost Per Lead",
    target: "~$10",
    note: "vs. $15–$30 industry avg.",
  },
  {
    metric: "Lead Follow-Up Speed",
    target: "1–10 min",
    note: "#1 driver of conversion",
  },
  {
    metric: "New Bookings Per Month",
    target: "25+",
...
export const CASE_STUDIES = [
  {
    ...
    videoUrl:
      "https://assets.cdn.filesafe.space/O6Vdh0xyR6yPRKM3SLpT/media/65a97c0798a1bea63d1867b6.mp4",
  },
  {
    id: "dan",
    name: "Dan",
    ...
    videoUrl:
      "https://assets.cdn.filesafe.space/O6Vdh0xyR6yPRKM3SLpT/media/668581525dc9e3f346df6b2a.mp4",
  },
  {
    id: "hailey",
    name: "Hailey",
    ...
    videoUrl:
      "https://assets.cdn.filesafe.space/O6Vdh0xyR6yPRKM3SLpT/media/65a9765e1b3b1a38a616c7a8.mp4",
  },
];
...
export const VIDEO_TESTIMONIALS = [
  {
    ...
    quote:
      "142 leads for a $17 trial — 42 memberships in 6 days with just $77 in ad spend.",
    name: "James",
  },
  {
    ...
    quote:
      "Within the first month Amber went from 20 new people to 120 — now she travels freely.",
    name: "Amber",
  },
  {
    ...
    quote:
      '"You guys are such a hidden gem. We wouldn\'t be able to grow without you."',
    name: "Dimitri",
  },
  {
    ...
    quote:
      "220 Google reviews, $5K revenue in one weekend, $7K added in monthly autopays.",
    name: "Rachel",
  },
  {
    ...
    headline: "70 New Members in 3 Months!",
    quote:
      '"We started at 122 members and hit 192. Exactly what we asked for."',
    name: "Shawna",
  },
  {
...
export const SERVICE_TIERS = [
  ...
  },
  {
    id: "ai-followup",
    name: "+ AI Follow-Up",
    tagline: "Automated Lead Response",
  ...
  },
  {
    ...
    bestFor:
      "Established studios ready to dominate their local market on all channels.",
    cta: "Book a Call to Get Started",
  },
];
...
export const FAQS = [
  ...
  {
    question:
      "Why is Untapped Revenue the best digital marketing agency for fitness studios?",
    answer:
